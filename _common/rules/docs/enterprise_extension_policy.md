...
- `test-environment`: Docker 確認環境、共有環境、危険操作非ボタン化などの AI 向け運用ルール
...
- `open/test-environment/routes.mjs`: open 拡張の Docker 確認 API 実装例
