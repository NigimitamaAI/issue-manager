...
function fmtItem(t) {
  ...
  if (t.status && !['todo', 'doing', 'review', 'blocked', 'done', 'inbox'].includes(t.status)) {
...
// レーン全件レンダリング。doing/review/blocked/todo/inbox 用。
